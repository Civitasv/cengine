...
void Sandbox2D::OnUpdate(Cazel::Timestep ts) {
...

  {
    ...
    Cazel::Renderer2D::DrawRotatedQuad({1.0f, 0.0f}, {0.8f, 0.8f}, -45.0f,
                                       {0.8f, 0.2f, 0.3f, 1.0f});
    Cazel::Renderer2D::DrawQuad({-1.0f, 0.0f}, {0.8f, 0.8f},
                                {0.8f, 0.2f, 0.3f, 1.0f});
    Cazel::Renderer2D::DrawQuad({0.5f, -0.5f}, {0.5f, 0.75f}, m_SquareColor);
    Cazel::Renderer2D::DrawQuad({0.0f, 0.0f, -0.1f}, {20.0f, 20.0f},
